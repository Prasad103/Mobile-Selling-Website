...
<body>
            ...
            <div class="product-box">
                <div class="all-images">
                    <div class="small-images">
                        <img src="iphon 12 Mini-1.png" onclick="clickimg(this)">
                        <img src="iphon 12 Mini-2.png" onclick="clickimg(this)">
                        <img src="iphon 12 Mini-3.png" onclick="clickimg(this)">

                    </div>
                    <div class="main-images">
                        <img src="iphon 12 Mini-1.png" id="imagebox">
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="contect">
                    ...
                    <h2>Apple iphon 12 Mini (Red, 64GB)</h2>
                    <div class="review" style="background-color: black;">

                        <div><iframe width="560" height="200" src="https://www.youtube.com/embed/am2D1p7Cwiw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
    ...
    <script>
        ...
        function myFunction() {
            alert("Produt is added to Cart Successfully")
        }
    </script>
