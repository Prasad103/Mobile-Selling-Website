            ...
            <div class="product-box">
                <div class="all-images">
                    <div class="small-images">
                        <img src="iphon 13 Pro Max-1.png" onclick="clickimg(this)">
                        <img src="iphon 13 Pro Max-2.png" onclick="clickimg(this)">
                        <img src="iphon 13 Pro Max-3.png" onclick="clickimg(this)">
                        <img src="iphon 13 Pro Max-4.png" onclick="clickimg(this)">
                        <img src="iphon 13 Pro Max-5.png" onclick="clickimg(this)">

                    </div>
                    <div class="main-images">
                        <img src="iphon 13 Pro Max-1.png" id="imagebox">
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="contect">
                    ...
                    <h2>Apple iphon 13 Pro Max (grey, 64GB)</h2>
                    <div class="review" style="background-color: black;">
                        <div><iframe width="560" height="200" src="https://www.youtube.com/embed/nkRFu0TqPew" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
