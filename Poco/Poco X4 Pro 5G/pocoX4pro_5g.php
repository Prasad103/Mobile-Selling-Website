            ...
            <div class="product-box">
                <div class="all-images">
                    <div class="small-images">
                        <img src="Poco X4 Pro 5G-1.png" onclick="clickimg(this)">
                        <img src="Poco X4 Pro 5G-2.png" onclick="clickimg(this)">
                        <img src="Poco X4 Pro 5G-3.png" onclick="clickimg(this)">
                        <img src="Poco X4 Pro 5G-4.png" onclick="clickimg(this)">

                    </div>
                    <div class="main-images">
                        <img src="Poco X4 Pro 5G-1.png" id="imagebox">
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="contect">
                    ...
                    <h2>Poco X4 Pro (Laser Black, 128GB)</h2>
                    <div class="review" style="background-color: black;">
                        <div>
                            <iframe width="560" height="200" src="https://www.youtube.com/embed/fID-vvZ7Nec" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="pricebox">
                        <p class="price">&#8377; 16,999 (30% off)</p>
                        <strike>&#8377; 22,999</strike>
                    </div>
