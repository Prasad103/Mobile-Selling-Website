            ...
            <div class="product-box">
                <div class="all-images">
                    <div class="small-images">
                        <img src="Poco M4 Pro-1.png" onclick="clickimg(this)">
                        <img src="Poco M4 Pro-2.png" onclick="clickimg(this)">
                        <img src="Poco M4 Pro-3.png" onclick="clickimg(this)">
                        <img src="Poco M4 Pro-4.png" onclick="clickimg(this)">

                    </div>
                    <div class="main-images">
                        <img src="Poco M4 Pro-1.png" id="imagebox">
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="contect">
                    ...
                    <h2>Poco M4 Pro (Black, 128GB)</h2>
                    <div class="review" style="background-color: black;">
                        <div>
                            <iframe width="560" height="200" src="https://www.youtube.com/embed/UayOpE8K2mU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    ...
                    <div class="pricebox">
                        <p class="price">&#8377; 12,999 (30% off)</p>
                        <strike>&#8377; 17,999</strike>
                    </div>
