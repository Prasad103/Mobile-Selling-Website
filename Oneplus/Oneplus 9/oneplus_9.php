            ...
            <div class="product-box">
                <div class="all-images">
                    <div class="small-images">
                        <img src="OnePlus 9-1.png" onclick="clickimg(this)">
                        <img src="OnePlus 9-3.png" onclick="clickimg(this)">
                        <img src="OnePlus 9-3.png" onclick="clickimg(this)">

                    </div>
                    <div class="main-images">
                        <img src="OnePlus 9-1.png" id="imagebox">
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="contect">
                    ...
                    <h2>OnePlus 9 (blue, 64GB)</h2>
                    <div class="review" style="background-color: black;">
                        <div>
                            <iframe width="560" height="200" src="https://www.youtube.com/embed/JZtIjn-7Gx0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
