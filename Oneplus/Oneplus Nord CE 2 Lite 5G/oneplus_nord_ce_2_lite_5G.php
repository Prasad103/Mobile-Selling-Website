...
<body>
            ...
            <div class="product-box">
                <div class="all-images">
                    <div class="small-images">
                        <img src="OnePlus Nord CE 2 Lite 5G-1.png" onclick="clickimg(this)">
                        <img src="OnePlus Nord CE 2 Lite 5G-2.png" onclick="clickimg(this)">
                        <img src="OnePlus Nord CE 2 Lite 5G-3.png" onclick="clickimg(this)">


                    </div>
                    <div class="main-images">
                        <img src="OnePlus Nord CE 2 Lite 5G-1.png" id="imagebox">
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="contect">
                    ...
                    <h2>OnePlus Nord CE 2 Lite 5G (Black, 64GB)</h2>
                    <div class="review" style="background-color: black;">

                        <div>
                            <iframe width="560" height="200" src="https://www.youtube.com/embed/Mc6BY6un7t8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    ...
                    <div class="pricebox">
                        <p class="price">&#8377; 31,999
                            <strike><small>&#8377;40,999</small></strike></p>
                    </div>
                    <p>Size : <select name="color">
    ...
    <script>
        ...
        function myFunction() {
            alert("Product is addedd to Cart Successfully")
        }
    </script>
