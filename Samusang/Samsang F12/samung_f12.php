            ...
            <div class="product-box">
                <div class="all-images">
                    <div class="small-images">
                        <img src="Samsung F12-1.png" onclick="clickimg(this)">
                        <img src="Samsung F12-2.png" onclick="clickimg(this)">
                        <img src="Samsung F12-3.png" onclick="clickimg(this)">
                        <img src="Samsung F12-4.png" onclick="clickimg(this)">

                    </div>
                    <div class="main-images">
                        <img src="Samsung F12-1.png" id="imagebox">
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="contect">
                    ...
                    <h2>Samsung Galaxy F12 (Sky Blue, 64GB)</h2>
                    <div class="review" style="background-color: black;">
                        <div><iframe width="560" height="200" src="https://www.youtube.com/embed/mTfe0-V61pc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                    ...
                    <a href="/project/order/2-order-form.php"><button class="buy">
                        <span class="fa fa--shopping-cart"></span>
                        Buy Now
                    </button></a>
                </div>
