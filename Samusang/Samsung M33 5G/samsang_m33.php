...
<head>
    ...
    <title>Samsang M33 5G-1.png </title>
            ...
            <div class="product-box">
                <div class="all-images">
                    <div class="small-images">
                        <img src="Samsung M33 5G-1.png" onclick="clickimg(this)">
                        <img src="Samsung M33 5G-2.png" onclick="clickimg(this)">
                        <img src="Samsung M33 5G-3.png" onclick="clickimg(this)">
                        <img src="Samsung M33 5G-4.png" onclick="clickimg(this)">
                    </div>
                    <div class="main-images">
                        <img src="Samsung M33 5G-1.png" id="imagebox">
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="contect">
                    ...
                    <h2>Samsung M33 5G (blue, 64GB)</h2>
                    <div class="review">

                        <div class="review" style="background-color: black;">
                            <div style="background-color: black;">
                                <iframe width="560" height="200" src="https://www.youtube.com/embed/EDifipXVq0s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
